...
%%% for the case of three-site exchange between sites A, B and C
...
%% save data
save('3siteModel_baseCase')
elseif newrun_yn==0
    load('3siteModel_baseCase.mat')
end
%% make plots
...
kgroundtruth=fiao_.*((1-fiao_).*AXRt+fiao_.*AXRg) +AXRt.*(1-fiao_); % may not actually be ground truth for three site exchange model

hl=plot((1-fiao_), kgroundtruth*1000);
hl.Color='r';
hl.LineStyle=':';

legend('0--300 mOsm','300--2000 mOsm','$(f_b+f_c)\lambda_2+f_a\lambda_3$','Location','southeast')
...
print(fig,'figure7.eps','-depsc')
print(fig,'figure7.png','-dpng','-r300')
